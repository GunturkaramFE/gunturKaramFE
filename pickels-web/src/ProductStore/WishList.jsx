...
const Wishlist = () => {
  ...
  useEffect(() => {
    ...
    console.log(parseShoppingData(shoppingData),'aihkjnhiuonmio')
    }, [shoppingData]);
  const defaultData = {
    id: 1,
    title: 'Product Title',
  ...
  return (<>{Wishlist.length?<div style={{
    width: '100%',
    height: '100vh',
    display: 'flex',
  ...
  </div>:<EmptyData text={"Your whishlist is currently empty"} buttonText={'Add more'} navlink={'/products'}/>}
    </>
  );
}
