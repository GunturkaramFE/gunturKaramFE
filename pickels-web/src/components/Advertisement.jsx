      ...
      <Grid sx={{width:"100%",height:{xs:"auto",sm:'83vh',md:"83vh",lg:'83vh'},backgroundColor:'#cceee4',paddingBottom:{xs:"20px",sm:"0px",md:"0px",lg:"0px"}}}>
       <Grid sx={{width:"100%",height:'60%',display:'flex',flexDirection:{xs:"column",sm:'row',md:'row',lg:'row'},alignItems:'center'}}>
            ...
            <img style={{height:"200px",objectFit:'contain',width:'100%'}} src='https://www.bigbasket.com/media/uploads/p/xxl/40178290_4-delight-foods-andhra-special-avakayamango-pickle.jpg' alt='$/'/>
             ...
             <Grid sx={{width:{xs:"100%",sm:'60%',md:'60%',lg:"60%"},height:'100%',display:'flex',justifyContent:'center',alignItems:'center'}}>
                <Grid sx={{width:"90%",height:'90%',display:'flex',flexDirection:'column',justifyContent:'space-evenly'}}>
                <Grid sx={{width:'100%'}}>
                <Typography sx={{fontSize:{xs:'27px',sm:"45px",md:"45px",lg:'45px'},fontWeight:'bold',fontFamily:'Arial Black'}}>Tangy ,Tasty ,Tartness !</Typography>
                </Grid>
                <Grid sx={{width:'100%'}}>
                ...
                <Grid>
                <Button sx={{width:{xs:"50%",sm:'30%',md:'30%',lg:'30%'},marginTop:{xs:"10px",sm:'0px',md:"0px",lg:'0px'},borderRadius:'22px',backgroundColor:'#4dc2a0',fontWeight:'bold'}} variant="contained">Know More ! </Button>
                </Grid>
                </Grid>
            </Grid>
       </Grid>
       <Grid sx={{width:"100%",height:'40%',display:"flex",justifyContent:'center',alignItems:'center',marginTop:{xs:'15px',sm:'0px',md:'0px',lg:'0px'}}}>
        <Grid sx={{width:{xs:"95%",sm:'80%',md:"80%",lg:'80%'},fontWeight:'bold',height:"100%",display:'flex',justifyContent:'space-evenly',alignItems:'start'}}>
   <Card  sx={{ width: {xs:"23%",sm:'20%',md:"20%",lg:'20%'}, height: {xs:"100px",sm:'75%',md:"75%",lg:'75%'}, display: 'flex', justifyContent: 'space-evenly', alignItems: 'center', flexDirection: "column", boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)' }}>
